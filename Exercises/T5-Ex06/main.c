#include"vector.c"
/*
Modificar el programa del ejercicio anterior de tal modo que las dos funciones
estén definidas en un archivo aparte del programa que las emplea. No emplees
